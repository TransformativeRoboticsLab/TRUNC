...
truss_s = load_data('./ansys/Truss/',["uniform_scaling_sim_results.csv"]);
truss_s_data = table2array(truss_s{1}(:,3:end));
truss_s_t2b = (truss_s_data(:,4)./truss_s_data(:,2))./(truss_s_data(:,3)./truss_s_data(:,1));
...
% 
% equitorial_s = load_data('./ansys/Equitorial/',["uniform_scaling_sim_results.csv"]);
% equitorial_s_data = table2array(equitorial_s{1}(:,3:end));
% equitorial_s_t2b = (equitorial_s_data(:,4)./equitorial_s_data(:,2))./(equitorial_s_data(:,3)./equitorial_s_data(:,1));
